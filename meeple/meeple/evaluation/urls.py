...
from .views import (
    home, signup, logout, preferences, recommendPage, StudiesView, create_study, edit_study, delete_section, questionnaries, questionnarie, newRecomm, get_data_game, prueba, create_section_ajax, delete_study
)
