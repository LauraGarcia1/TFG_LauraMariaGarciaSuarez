...
from .views import (
    home, signup, logout, preferences, recommendPage, StudiesView, create_study, edit_study, delete_section, questionnaries, questionnarie, newRecomm, get_data_game, prueba, create_section_ajax, delete_study, upload_study
)
...
urlpatterns = [
    ...
    path('my-studies/<int:pk>/delete/', delete_study, name='delete-questionnarie'),
    path('my-studies/<int:pk>/upload/', upload_study, name='upload-questionnarie'),
