...
from .views import (
    home, signup, logout, preferences, homeParticipant, StudiesView, create_study, edit_study, questionnaires, view_questionnaire, get_data_game, delete_study, upload_study, view_study, algorithms
)
...
urlpatterns = [
    ...
    path('my-recommendations/', homeParticipant, name='my-recommendations'),
